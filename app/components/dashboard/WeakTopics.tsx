...
const weakTopics = [
    { 
        ...
        topic: 'Deadlocks', 
        confidence: 62, 
        action: 'Review Unit 3',
        explanation: 'You consistently struggle with the four Coffman conditions for deadlock prevention and circular wait detection algorithms.' 
    },
    { 
        id: 2, 
        ...
        explanation: 'Your traversal speed is optimal, but you miss edge instances when balancing AVL trees and red-black tree insertion rotations.' 
    },
    { 
        id: 3, 
        ...
        explanation: 'Schrödinger wave equations are causing calculation delays. We suggest targeting probability density derivations in active recall.' 
    }
];
